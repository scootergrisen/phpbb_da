...
* @version $Id: ucp.php 585 2017-07-23 08:20:20Z jan_skovsgaard $
*
...
$lang = array_merge($lang, array(
	...
	'ADD_FOES_EXPLAIN'				=> 'Du kan tilføje flere brugere, hver på en linje for sig.',
	'ADD_FOLDER'					=> 'Tilføj mappe',
	'ADD_FRIENDS'					=> 'Tilføj nye venner',
	'ADD_FRIENDS_EXPLAIN'			=> 'Du kan tilføje flere brugere, hver på en linje for sig.',
	...
	'AVATAR_DRIVER_LOCAL_EXPLAIN'	=> 'Du kan vælge din avatar fra et lokalt tilgængeligt udvalg af avatarer.',
	'AVATAR_DRIVER_REMOTE_TITLE'	=> 'Fjern-avatar',
	'AVATAR_DRIVER_REMOTE_EXPLAIN'	=> 'Link til avatarbillede på andet websted.',
	...
	'AVATAR_EXPLAIN_NO_FILESIZE'	=> 'Tilladte maksimum dimensioner, bredde: %1$s, højde: %2$s.',
	'AVATAR_FEATURES_DISABLED'		=> 'Muligheden for at anvende avatarer er deaktiveret.',
	'AVATAR_GALLERY'				=> 'Lokalt galleri',
	'AVATAR_GENERAL_UPLOAD_ERROR'	=> 'Kunne ikke uploade avatar til %s.',
	'AVATAR_NOT_ALLOWED'			=> 'Din avatar vises ikke, da brug af avatarer er blevet deaktiveret.',
	'AVATAR_PAGE'					=> 'Side',
	...
	'BACK_TO_LOGIN'				=> 'Tilbage til loginside',
	'BIRTHDAY'					=> 'Fødselsdag',
	...
	'BOOKMARKS'					=> 'Bogmærker',
	'BOOKMARKS_EXPLAIN'			=> 'Du kan bogmærke emner for fremtidig reference. Vælg det eller de bogmærker du ønsker at slette, klik derefter på knappen <em>Fjern valgte bogmærker</em>.',
	...
	'CLICK_RETURN_FOLDER'		=> '%1$sTilbage til din "%3$s"%2$s',
	...
	'VC_REFRESH'	=> 'Ny bekræftelseskode',
	...
	'DEFAULT_SMILIES'			=> 'Smileys aktiveret som standard',
	'DEFINED_RULES'				=> 'Definerede regler',
	'DELETED_TOPIC'				=> 'Emne er blevet fjernet.',
	...
	'DELETE_MESSAGE_CONFIRM'	=> 'Er du sikker på, at du vil slette denne private besked?',
	...
	'FIELD_TOO_LONG'			=> array(
		1	=> 'Feltet "%2$s" er for langt, maksimalt %1$d tegn er tilladt.',
		2	=> 'Feltet "%2$s" er for langt, maksimalt %1$d tegn er tilladt.',
	),
	...
	'FORCE_PASSWORD_EXPLAIN'	=> 'Før du fortsætter med at gennemse boardet er du nødt til at ændre din adgangskode.',
	...
	'INVALID_USER_BIRTHDAY'		=> 'Den indtastede fødselsdag er ikke en gyldig dato.',
	'INVALID_CHARS_USERNAME'	=> 'Brugernavnet indeholder ikke tilladte tegn.',
	'INVALID_CHARS_NEW_PASSWORD'=> 'Adgangskoden indeholder ikke de krævede tegn.',
	...
	'LINK_REMOTE_SIZE_EXPLAIN'	=> 'Indtast bredden og højden af avataren, lad være tom for at forsøge automatisk verifikation.',
	...
	'MARK_IMPORTANT'			=> 'Vælg/fravælg som vigtig',
	...
	'NEW_PASSWORD_CONFIRM_EMPTY'	=> 'Du indtastede ikke en bekræftende adgangskode.',
	'NEW_PASSWORD_ERROR'		=> 'De indtastede adgangskoder er ikke identiske.',
	...
	'NO_ACTION_MODE'			=> 'Ingen handling for beskeden indtastet.',
	...
	'NO_AUTH_PASSWORD_REMINDER'	=> 'Du har ikke tilladelse til at rekvirere en ny adgangskode.',
	...
	'NO_GROUP_SELECTED'			=> 'Ingen gruppe indtastet.',
	...
	'NO_PASSWORD_SUPPLIED'		=> 'Du kan ikke logge ind uden en adgangskode.',
	...
	'PASS_TYPE_ALPHA_EXPLAIN'	=> 'Adgangskoden skal være mellem %1$s og %2$s. Og det skal indeholde både tal og store og små bogstaver.',
	'PASS_TYPE_ANY_EXPLAIN'		=> 'Skal være mellem %1$s og %2$s.',
	'PASS_TYPE_CASE_EXPLAIN'	=> 'Adgangskoden skal være mellem %1$s og %2$s. Og det skal indeholde både store og små bogstaver.',
	...
	'PROFILE_AUTOLOGIN_KEYS'	=> '"Husk mig"-nøglen anvendes til automatisk login når du besøger boardet. Hvis du logger ud, slettes nøglen på den computer du logger ud fra. Her har du mulighed for se nøgler oprettet fra andre computere du har besøgt boardet fra.',
	...
	'REMOVE_SELECTED_BOOKMARKS_CONFIRM' => 'Er du sikker på, at du vil slette alle valgte bogmærker?',
	'REMOVE_BOOKMARK_MARKED'	=> 'Fjern valgte bogmærker',
	'REMOVE_FOLDER'				=> 'Fjern mappe',
	'REMOVE_FOLDER_CONFIRM'		=> 'Er du sikker på, at du vil fjerne denne mappe?',
	'RENAME'					=> 'Omdøb',
	...
	'RESIGN_SELECTED'			=> 'Opgiv valgte',
	'RETURN_FOLDER'				=> '%1$sGå tilbage til forrige mappe%2$s',
	...
	'RULE_NOT_DEFINED'			=> 'Regel ikke korrekt indtastet.',
	'RULE_REMOVED_MESSAGES'		=> array(
		1	=> '%d privat besked er blevet fjernet på grund af filtre for private beskeder.',
		2	=> '%d private beskeder er blevet fjernet på grund af filtre for private beskeder.',
	),

	'SAME_PASSWORD_ERROR'		=> 'Den nye adgangskode du indtastede er det samme som din nuværende adgangskode.',
	...
	'UCP_AUTH_LINK_MANAGE'		=> 'Ekstern godkendelse',
	...
	'UPLOAD_AVATAR_URL_EXPLAIN'		=> 'Indtast URL\'en for den specifikke placering af det billede du vil anvende som din avatar. Billedet bliver herefter kopieret til denne side.',
	'USERNAME_ALPHA_ONLY_EXPLAIN'	=> 'Brugernavn skal være mellem %1$s og %2$s og brug kun alfanumeriske tegn.',
	'USERNAME_ALPHA_SPACERS_EXPLAIN'=> 'Brugernavn skal være mellem %1$s og %2$s og brug alfanumeriske tegn, mellemrum eller -, +, _, [ og ].',
	'USERNAME_ASCII_EXPLAIN'		=> 'Brugernavn skal være mellem %1$s og %2$s og brug kun ASCII-tegn, altså ingen specialsymboler.',
	'USERNAME_LETTER_NUM_EXPLAIN'	=> 'Brugernavn skal være mellem %1$s og %2$s og brug kun bogstaver og tal (alfanumeriske tegn).',
	'USERNAME_LETTER_NUM_SPACERS_EXPLAIN'	=> 'Brugernavn skal være mellem %1$s og %2$s og brug alfanumeriske tegn, mellemrum eller -, +, _, [ og ].',
	'USERNAME_CHARS_ANY_EXPLAIN'	=> 'Længde skal være mellem %1$s og %2$s.',
	...
	'VIEW_PREVIOUS_HISTORY'		=> 'Forrige PB i historik',
	'VIEW_PREVIOUS_PM'			=> 'Forrige PB',
	...
	'YOUR_FOES_EXPLAIN'			=> 'Du kan fjerne brugere ved at vælge disse og klikke på Indsend.',
	'YOUR_FRIENDS'				=> 'Dine venner',
	'YOUR_FRIENDS_EXPLAIN'		=> 'Du kan fjerne brugere ved at vælge disse og klikke på Indsend.',
	...
	'NO_PENDING'	=> 'Ingen afventende medlemskaber',
