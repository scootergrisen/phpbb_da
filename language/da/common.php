...
* @version $Id: common.php 589 2018-01-20 07:54:36Z jan_skovsgaard $
*
...
$lang = array_merge($lang, array(
	'TRANSLATION_INFO'	=> 'Dansk oversættelse &amp; hjælp: <a href="http://phpbb3.dk/">Olympus DK Team</a>',
	'DIRECTION'			=> 'ltr',
	...
	'ACP_SHORT'						=> 'ACP',
	'ACTIVE'						=> 'aktiv',
	'ACTIVE_ERROR'					=> 'Det indtastede brugernavn er i øjeblikket ikke aktivt. Kontakt venligst en boardadministrator, hvis du har problemer med at aktivere din konto.',
	...
	'ALL_TIMES'						=> 'Alle tider er <span title="%2$s">%1$s</span>',
	...
	'ATTACHED_IMAGE_NOT_IMAGE'		=> 'Den billedefil du forsøgte at vedhæfte er ugyldig.',
	'AUTHOR'						=> 'Forfatter',
	'AUTH_NO_PROFILE_CREATED'		=> 'Oprettelse af brugerprofil mislykkedes.',
	'AUTH_PROVIDER_OAUTH_ERROR_INVALID_ENTRY'				=> 'Ugyldig databaseforespørgsel.',
	'AUTH_PROVIDER_OAUTH_ERROR_INVALID_SERVICE_TYPE'		=> 'Ugyldig servicetype afsendt til OAuth-tjenesten.',
	...
	'AVATAR_EMPTY_REMOTE_DATA'		=> 'Indtastede avatar kunne ikke uploades, fordi data fra den eksterne server ser ud til at være ugyldige eller ødelagte.',
	...
	'AVATAR_NO_TEMP_DIR'			=> 'Midlertidig mappe findes ikke eller kan ikke skrives til.',
	...
	'BACK_TO_TOP'			=> 'Top',
	'BACK_TO_PREV'			=> 'Tilbage til forrige side',
	'BAN_TRIGGERED_BY_EMAIL'=> 'Din e-mailadresse er blevet udelukket.',
	'BAN_TRIGGERED_BY_IP'	=> 'Din IP-adresse er blevet udelukket.',
	'BAN_TRIGGERED_BY_USER'	=> 'Dit brugernavn er blevet udelukket.',
	'BBCODE_GUIDE'			=> 'BBkode-vejledning',
	'BCC'					=> 'BCC',
	...
	'BOARD_BAN_REASON'		=> 'Udelukkelsesårsag: <strong>%s</strong>',
	...
	'BROWSING_FORUM'		=> 'Brugere der viser dette forum: %1$s',
	'BROWSING_FORUM_GUESTS'	=> array(
		1	=> 'Brugere der viser dette forum: %2$s og %1$d gæst',
		2	=> 'Brugere der viser dette forum: %2$s og %1$d gæster',
	),
	'BUTTON_EDIT'			=> 'Rediger',
	...
	'CONFIRM_CODE_EXPLAIN'	=> 'Indtast koden præcis som du ser den i billedet. Der skelnes ikke mellem store og små bogstaver.',
	'CONFIRM_CODE_WRONG'	=> 'Den indtastede bekræftelseskode er ugyldig.',
	'CONFIRM_OPERATION'		=> 'Er du sikker på, at du vil udføre denne handling?',
	...
	'COOKIE_CONSENT_INFO'	=> 'Lær mere',
	'COOKIE_CONSENT_MSG'	=> 'Vi bruger cookies for at sikre du får den bedste oplevelse på vort websted.',
	...
	'DISPLAY_POSTS'			=> 'Vis indlæg fra forrige',
	...
	'EMAIL_INVALID_EMAIL'				=> 'Den indtastede e-mailadresse er ugyldig.',
	'EMAIL_SMTP_ERROR_RESPONSE'			=> 'Løb ind i problemer med at sende e-mail: <strong>Linje %1$s</strong>. Svar: %2$s.',
	'EMPTY_SUBJECT'						=> 'Du skal indtaste et emne når du skriver et nyt indlæg.',
	'EMPTY_MESSAGE_SUBJECT'				=> 'Du skal indtaste et emne når du skriver en ny besked.',
	'ENABLED'							=> 'Aktiv',
	'ENCLOSURE'							=> 'Bilag',
	...
	'ERR_UNABLE_TO_LOGIN'				=> 'Indtastede brugernavn eller adgangskode er ikke korrekt.',
	...
	'ERR_WRONG_PATH_TO_PHPBB'			=> 'Den indtastede phpBB-sti synes at være ugyldig.',
	'ERROR'									=> 'Fejl',
	...
	'FEATURE_NOT_AVAILABLE' => 'Den krævede funktion er ikke tilgængelig på dette board.',
	'FILENAME'				=> 'Filnavn',
	...
	'FOLDER'				=> 'Mappe',
	'FORGOT_PASS'			=> 'Jeg har glemt min adgangskode',
	'FORM_INVALID'			=> 'Den indsendte formular var ugyldig. Prøv at indsende igen.',
	'FORUM'					=> 'Forum',
	'FORUMS'				=> 'Fora',
	'FORUMS_MARKED'			=> 'Fora blev markeret som læste.',
	...
	'FSOCK_TIMEOUT'			=> 'Ventetiden udløb under læsning af netværksstrøm.',

	'FTP_FSOCK_HOST'				=> 'FTP-vært',
	'FTP_FSOCK_HOST_EXPLAIN'		=> 'FTP-server der bruges til at forbinde til dit sted.',
	'FTP_FSOCK_PASSWORD'			=> 'FTP-adgangskode',
	'FTP_FSOCK_PASSWORD_EXPLAIN'	=> 'Adgangskode for din FTP-bruger.',
	...
	'FTP_HOST'					=> 'FTP-vært',
	'FTP_HOST_EXPLAIN'			=> 'FTP-server der bruges til at forbinde til dit sted.',
	'FTP_PASSWORD'				=> 'FTP-adgangskode',
	'FTP_PASSWORD_EXPLAIN'		=> 'Adgangskode for din FTP-bruger.',
	'FTP_PORT'					=> 'FTP-port',
	...
	'GROUP_ERR_USERNAME'		=> 'Intet gruppenavn indtastet.',
	'GROUP_ERR_USER_LONG'		=> 'Gruppenavne må ikke være længere end 60 tegn. Det indtastede gruppenavn er for langt.',
	'GUEST'						=> 'Gæst',
	...
	'INVALID_DIGEST_CHALLENGE'	=> 'Ugyldig digest challenge.',
	'INVALID_EMAIL_LOG'			=> '<strong>%s</strong> er muligvis en ugyldig e-mailadresse?',
	'INVALID_FEED_ATTACHMENTS'	=> 'Det valgte feed forsøgte at hente vedhæftede filer med ugyldigt kriterium.',
	...
	'LOGIN_CONFIRM_EXPLAIN'				=> 'For at hindre brute force-hacking af brugerkonti, bedes du efter et antal forfejlede loginforsøg, indtaste en bekræftelseskode eller svare på et spørgsmål. Koden eller spørgsmålet ses herunder. Er du synshandicappet eller af andre årsager ikke kan læse koden bedes du kontakte %sboardadministrator%s.', //unused
	'LOGIN_ERROR_ATTEMPTS'				=> 'Du har overskredet antallet af tilladte loginforsøg. Du bedes derfor igen at indtaste brugernavn og adgangskode, og desuden indtaste en vist bekræftelseskode eller svare på et spørgsmål herunder.',
	...
	'LOGIN_ERROR_PASSWORD'				=> 'Du har indtastet forkert adgangskode. Kontroller venligst din adgangskode, og prøv igen. Hvis du fortsat har problemer, kontakt venligst %sboardadministrator%s.',
	'LOGIN_ERROR_PASSWORD_CONVERT'		=> 'Det var ikke muligt at konvertere din adgangskode under opdatering af dette boards software. Rekvirer venligst %sen ny adgangskode%s. Kontakt venligst %sboardadministrator%s, hvis du fortsat har problemer.',
	'LOGIN_ERROR_USERNAME'				=> 'Du har indtastet et forkert brugernavn. Kontroller venligst dit brugernavn, og prøv igen. Hvis du fortsat har problemer, kontakt venligst %sboardadministrator%s.',
	'LOGIN_FORUM'						=> 'For at læse eller skrive i dette forum skal du indtaste dets adgangskode.',
	...
	'MARK'					=> 'Vælg',
	'MARK_ALL'				=> 'Vælg alle',
	'MARK_ALL_READ'			=> 'Mærk alle som læste',
	'MARK_FORUMS_READ'		=> 'Mærk fora som læste',
	'MARK_READ'				=> 'Mærk som læste',
	'MARK_SUBFORUMS_READ'	=> 'Mærk underfora som læste',
	'MB'					=> 'MB',
	'MIB'					=> 'MiB',
	'MCP'					=> 'Redaktørkontrolpanel',
	'MCP_SHORT'				=> 'MCP',
	'MEMBERLIST'			=> 'Tilmeldte brugere',
	'MEMBERLIST_EXPLAIN'	=> 'Vis komplet liste over tilmeldte brugere',
	'MERGE'					=> 'Sammenlæg',
	...
	'MESSAGE_BODY'			=> 'e-mail-indhold',	// Bruges kun i memberlist_email.html
	'MINUTES'				=> 'minutter',
	'MODERATE'				=> 'Rediger',
	'MODERATOR'				=> 'Redaktør',
	'MODERATORS'			=> 'Redaktører',
	'MODULE_NOT_ACCESS'		=> 'Modulet kunne ikke tilgås',
	'MODULE_NOT_FIND'		=> 'Kan ikke finde modulet %s',
	...
	'NOTIFICATION_BOOKMARK'				=> array(
		1	=> '<strong>Svar</strong> fra %1$s i bogmærket emne:',
	),
	...
	'NOTIFICATION_METHOD_INVALID'		=> 'Metoden "%s" refererer ikke til en gyldig notifikationsmetode.',
	'NOTIFICATION_PM'					=> '<strong>Privat besked</strong> fra %1$s:',
	'NOTIFICATION_POST'					=> array(
		1	=> '<strong>Svar</strong> fra %1$s i emnet:',
	),
	...
	'NO_ACTION'					=> 'Ingen handling indtastet.',
	...
	'PAGE_NOT_FOUND'		=> 'Siden findes ikke.',
	...
	'RESEND_ACTIVATION'			=> 'Gensend aktiveringse-mail',
	'RESET'						=> 'Nulstil',
	...
	'RETURN_PAGE'				=> '%sTilbage til forrige side%s',
	...
	'SEND_EMAIL'				=> 'Send e-mail',	// Used for submit buttons
	'SEND_EMAIL_USER'			=> 'Send e-mail til %s',
	...
	'SORT_OPTIONS'				=> 'Muligheder for visning og sortering',
	'SORT_RANK'					=> 'Rang',
	'SORT_POSTS'				=> 'Indlæg',
	'SORT_TOPIC_TITLE'			=> 'Emnetitel',
	'SORT_USERNAME'				=> 'Brugernavn',
	'SPLIT_TOPIC'				=> 'Opdel emne',
	'SQL_ERROR_OCCURRED'		=> 'Der opstod en SQL-fejl ved visning af denne side. Kontakt venligst %sboardadministrator%s hvis problemet fortsætter.',
	...
	'TIB'				=> 'TiB',
	'TIME'				=> 'Tid',
	'TIMEOUT_PROCESSING_REQ'		=> 'Forespørgsel udløb.',

	'TOO_LARGE'						=> 'Den indtastede værdi er for stor.',
	'TOO_LARGE_MAX_RECIPIENTS'		=> 'Du indtastede et for højt antal i indstillingen af <strong>Maksimalt antal tilladte modtagere af private beskeder</strong>.',
	...
	'TOO_LONG_JABBER'				=> 'Det indtastede Jabberkontonavn er for langt.',
	'TOO_LONG_NEW_PASSWORD'			=> 'Den indtastede adgangskode er for lang.',
	'TOO_LONG_PASSWORD_CONFIRM'		=> 'Den indtastede bekræftelse af adgangskode er for lang.',
	'TOO_LONG_USER_PASSWORD'		=> 'Den indtastede adgangskode er for lang.',
	'TOO_LONG_USERNAME'				=> 'Det indtastede brugernavn er for langt.',
	'TOO_LONG_EMAIL'				=> 'Den indtastede e-mailadresse er for lang.',
	...
	'TOO_SHORT_JABBER'				=> 'Det indtastede Jabberkontonavn er for kort.',
	'TOO_SHORT_NEW_PASSWORD'		=> 'Den indtastede adgangskode er for kort.',
	'TOO_SHORT_PASSWORD_CONFIRM'	=> 'Den indtastede bekræftelse af adgangskode er for kort.',
	'TOO_SHORT_USER_PASSWORD'		=> 'Den indtastede adgangskode er for kort.',
	'TOO_SHORT_USERNAME'			=> 'Det indtastede brugernavn er for kort.',
	'TOO_SHORT_EMAIL'				=> 'Den indtastede e-mailadresse er for kort.',
	'TOO_SHORT_EMAIL_CONFIRM'		=> 'Den indtastede e-mailadressebekræftelse var for kort.',
	'TOO_SMALL'						=> 'Den indtastede værdi er for lille.',
	'TOO_SMALL_MAX_RECIPIENTS'		=> 'Du indtastede et for lavt antal i indstillingen af <strong>Maksimalt antal tilladte modtagere af private beskeder</strong>.',

	'TOPIC'				=> 'Emne',
	'TOPICS'			=> 'Emner',
	'TOPICS_UNAPPROVED'	=> 'Mindst et emne i forummet er ikke godkendt.',
	'TOPIC_ICON'		=> 'Emneikon',
	'TOPIC_LOCKED'		=> 'Dette emne er låst, du kan ikke redigere eller skrive yderligere indlæg.',
	'TOPIC_LOCKED_SHORT'=> 'Emne låst',
	'TOPIC_MOVED'		=> 'Flyttet emne',
	'TOPIC_REVIEW'		=> 'Gennemgang af emne',
	'TOPIC_TITLE'		=> 'Emnetitel',
	'TOPIC_UNAPPROVED'	=> 'Emnet er ikke godkendt.',
	'TOPIC_DELETED'		=> 'Emnet er slettet.',
	...
	'UNABLE_GET_IMAGE_SIZE'	=> 'Det var ikke muligt at fastslå billedets dimensioner. Kontroller venligst at den indtastede URL er korrekt.',
	...
	'USER_NEW_PERMISSION_DISALLOWED'	=> 'Vi beklager, men du har ikke tilladelse til at bruge denne mulighed. For at anvende den, skal du være tilmeldt og deltage mere aktivt i debatterne.',
	...
	'VIEWING_CONTACT_ADMIN'		=> 'Viser kontaktformularen',
	'VIEWING_FAQ'				=> 'Viser OSS',
	'VIEWING_MEMBERS'			=> 'Viser oplysning om bruger',
	'VIEWING_ONLINE'			=> 'Viser hvem der er online',
	'VIEWING_MCP'				=> 'Viser redaktørkontrolpanel',
	'VIEWING_MEMBER_PROFILE'	=> 'Viser brugerprofil',
	'VIEWING_PRIVATE_MESSAGES'	=> 'Viser private beskeder',
	'VIEWING_REGISTER'			=> 'Viser tilmeldte brugere',
	'VIEWING_UCP'				=> 'Viser brugerkontrolpanel',
	'VIEWS'						=> 'Visninger',
	'VIEW_BOOKMARKS'			=> 'Vis bogmærker',
	'VIEW_FORUM_LOGS'			=> 'Vis log',
	...
	'WRONG_PASSWORD'	=> 'Du indtastede en forkert adgangskode.',

	'WRONG_DATA_COLOUR'			=> 'Den indtastede farveværdi er ugyldig.',
	'WRONG_DATA_JABBER'			=> 'Det indtastede navn er et ugyldigt Jabberkontonavn.',
	'WRONG_DATA_LANG'			=> 'Det valgte sprog er ugyldigt.',
	'WRONG_DATA_POST_SD'		=> 'Den valgte sortingsretning af indlæg er ugyldig.',
	'WRONG_DATA_POST_SK'		=> 'Den valgte sorteringsmetode af indlæg er ugyldig.',
	'WRONG_DATA_TOPIC_SD'		=> 'Den valgte sortingsretning af emner er ugyldig.',
	'WRONG_DATA_TOPIC_SK'		=> 'Den valgte sorteringsmetode af emner er ugyldig.',
	'WROTE'						=> 'skrev',
