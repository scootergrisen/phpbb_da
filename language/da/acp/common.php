...
* @version $Id: common.php 586 2017-07-23 12:23:55Z jan_skovsgaard $
*
...
$lang = array_merge($lang, array(
	...
	'ACP_HELP_PHPBB'			=> 'Hjælp støtten til phpBB',

	'ACP_ICONS'					=> 'Emneikoner',
	'ACP_ICONS_SMILIES'			=> 'Emneikoner/smileys',
	...
	'ACP_SERVER_SETTINGS'		=> 'URL, gzip & stier',
	...
	'GLOBAL_MASK'			=> 'Global tilladelsesmaske',
	...
	'USERNAMES_EXPLAIN'		=> 'Anfør hvert brugernavn på en linje for sig.',
	'USER_CONTROL_PANEL'	=> 'Brugerkontrolpanel',

	'UPDATE_NEEDED'			=> 'Boardet er ikke opdateret.',
	'UPDATE_NOT_NEEDED'		=> 'Boardet er opdateret.',
...
$lang = array_merge($lang, array(
	...
	'ADMIN_LOG_INDEX_EXPLAIN'	=> 'De seneste 5 handlinger udført af administratorer. Den komplette log kan vises ved at klikke på linket "Se administratorlog" herunder. Denne og alle øvrige logge kan også ses via fanebladet "Vedligehold".',
	...
	'ERROR_MBSTRING_ENCODING_TRANSLATION'			=> 'Gennemsigtig kodning af tegn er fejlkonfigureret',
	...
	'PHP_VERSION_OLD'	=> 'Den PHP-version der er installeret på denne server (%1$s), understøttes ikke i fremtidige versioner af phpBB. Mindst PHP-version %2$s er krævet. %3$sDetaljer%4$s',
	...
	'TIMEZONE_INVALID'	=> 'Den valgte tidszone er ugyldig.',
	...
	'VERSIONCHECK_INVALID_ENTRY'	=> 'Seneste versionsinformation indeholder et ikke understøttet element.',
	'VERSIONCHECK_INVALID_URL'		=> 'Seneste versionsinformation indeholder ugyldig URL.',
	'VERSIONCHECK_INVALID_VERSION'	=> 'Seneste versionsinformation indeholder en ugyldig version.',
	'VERSION_NOT_UP_TO_DATE_ACP'	=> 'Din version af phpBB er ikke opdateret.<br />Nedenfor finder du et link til udgivelsesbekendtgørelsen for den seneste version, såvel som instruktioner om udførsel af opdateringen.',
...
$lang = array_merge($lang, array(
	...
	'SEND_STATISTICS'			=> 'Send statistikker',
	'SEND_STATISTICS_LONG'		=> 'Send statistikdata',
	'SHOW_STATISTICS'			=> 'Vis detaljer',
	'THANKS_SEND_STATISTICS'	=> 'Tak for din fremsendte information.',
	'FAIL_SEND_STATISTICS'		=> 'phpBB kunne ikke fremsende statistikker',
));
...
$lang = array_merge($lang, array(
	...
	'LOG_CLEAR_USERS'		=> '<strong>Tømt brugerlogge</strong>',
	...
	'LOG_CONFIG_FEED'			=> '<strong>Ændret indstillinger for feeds</strong>',
	...
	'LOG_CONFIG_VISUAL'			=> '<strong>Ændret indstillinger for spambot-beskyttelse</strong>',
	...
	'LOG_FORUM_SYNC'						=> '<strong>Resynkroniseret forum</strong><br />» %s',
	...
	'LOG_JAB_PASSCHG'			=> '<strong>Ændret adgangskode for Jabber</strong>',
	...
	'LOG_RESYNC_POSTCOUNTS'		=> '<strong>Brugeres indlægstællere resynkroniseret</strong>',
	'LOG_RESYNC_POST_MARKING'	=> '<strong>Prikkede emner resynkroniseret</strong>',
	'LOG_RESYNC_STATS'			=> '<strong>Indlæg-, emne- og brugerstatistikker resynkroniseret</strong>',
	...
	'LOG_TEMPLATE_CACHE_CLEARED'	=> '<strong>Mellemlagret tømt for <em>%1$s</em> skabelonfiler</strong><br />» %2$s',
	...
	'LOG_USER_NEW_PASSWORD'	=> '<strong>Ændret adgangskode for</strong><br />» %s',
	...
	'LOG_EXT_UPDATE'	=> '<strong>Udvidelse opdateret</strong><br />» %s',
));
