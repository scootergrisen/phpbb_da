...
* @version $Id: attachments.php 586 2017-07-23 12:23:55Z jan_skovsgaard $
*
...
$lang = array_merge($lang, array(
	...
	'DEFINE_ALLOWED_IPS'			=> 'Indtast hvidlistede IP-adresser eller værtsnavne',
	'DEFINE_DISALLOWED_IPS'			=> 'Indtast sortlistede IP-adresser eller værtsnavne',
	'DOWNLOAD_ADD_IPS_EXPLAIN'		=> 'For at specificere flere forskellige IP-adresser eller værtsnavne, skrives de hver især på en linje for sig. For at specificere et interval af IP-adresser adskilles starten og slutningen med en bindestreg (eks: 202.123.228.100-202.123.228.125). Brug * som ubekendt for ukendte tegn.',
	'DOWNLOAD_REMOVE_IPS_EXPLAIN'	=> 'Du kan fjerne flere IP-adresser i en arbejdsgang, ved at bruge den rette kombination af mus og tastatur (afhængig af computer og browser). Ekskluderede IP-adresser er anført med fed skrift.',
	...
	'DISPLAY_ORDER'					=> 'Rækkefølge for vedhæftede filer',
	'DISPLAY_ORDER_EXPLAIN'			=> 'Vis vedhæftede filer sorteret efter dato og tid.',

	'EDIT_EXTENSION_GROUP'			=> 'Ændre filtypegruppe',
	'EXCLUDE_ENTERED_IP'			=> 'Vælg "Ja" for at ekskludere indtastede IP-adresse eller vært fra listen.',
	...
	'EXT_GROUP_DOWNLOADABLE_FILES'	=> 'Filer som kan downloades',
	...
	'FILES_STATS_WRONG'		=> 'Dine filstatistikker er sandsynligvis ikke korrekte og bør resynkroniseres. Aktuelle værdier: Antal vedhæftede filer = %1$d, Samlet størrelse af vedhæftede filer = %2$s.<br />Klik %3$sher%4$s for at synkronisere.',
	...
	'IMAGICK_PATH_EXPLAIN'		=> 'Den fulde sti til konverteringsprogrammet ImageMagick, for eksempel <samp>/usr/bin/</samp>.',
	...
	'MAX_IMAGE_SIZE_EXPLAIN'		=> 'Maksimale dimensioner for vedhæftede billeder. Kontrol af billededimensioner deaktiveres ved at sætte begge værdier til 0.',
	...
	'NO_EXT_GROUP'				=> 'Ingen',
	'NO_EXT_GROUP_NAME'			=> 'Intet gruppenavn indtastet',
	'NO_EXT_GROUP_SPECIFIED'	=> 'Ingen filtypegruppe indtastet.',
	'NO_FILE_CAT'				=> 'Ingen',
	...
	'SECURE_ALLOW_DENY_EXPLAIN'		=> 'Sikker download baseres på en <strong>hvidliste</strong> (tillad), hvor ingen andre end de indtastede kan downloade, eller på en <strong>sortliste</strong> (afvis), hvor kun de indtastede ikke kan downloade.',
