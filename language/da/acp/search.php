...
* @version $Id: search.php 576 2017-01-28 21:04:28Z jan_skovsgaard $
*
...
$lang = array_merge($lang, array(
	'ACP_SEARCH_INDEX_EXPLAIN'				=> 'Her kan du ændre og vedligeholde søgningen i søgemotorens indeks. Da du normalt kun bruger en motor bør alle de indeks du ikke bruger slettes. Efter ændring i søgeindstillingerne (for eksempel antallet af minimum og maksimum antal tegn), kan det være værd at overveje at genskabe indekset, for at afspejle disse ændringer.',
	...
	'MIN_SEARCH_AUTHOR_CHARS_EXPLAIN'		=> 'Brugere skal indtaste mindst dette antal tegn i navnet, for at udføre en søgning efter forfatter ved anvendelse af (*) som ubekendt. Hvis forfatterens brugernavn er kortere end dette antal tegn, kan der søges efter dennes indlæg ved at indtaste forfatterens fulde brugernavn.',
