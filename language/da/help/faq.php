...
$lang = array_merge($lang, array(
	...
	'HELP_FAQ_PMS_SPAM_ANSWER'	=> 'Vi er meget kede af at høre dette. Dette boards e-mailsystem har indbygget sikkerhedsforanstaltninger, som hjælper med til at identificere brugere, der sender den slags indhold. Du bør sende en kopi af e-mailen til dette boards administrator. Der er meget vigtigt at denne indeholder den såkaldte header, som indeholder information om den bruger der afsendte e-mailen. Boardadministratoren kan herefter vurdere evt. sanktioner.',
	'HELP_FAQ_PMS_SPAM_QUESTION'	=> 'Jeg har modtaget en e-mail, indeholdende spam eller en fornærmelse, fra en bruger på dette board!',
	...
	'HELP_FAQ_SEARCH_FORUM_ANSWER'	=> 'Ved at indtaste en søgestreng i søgeboksen, som afhængig af boardets typografi, normalt findes øverst på siden. Du får adgang til den avancerede søgning ved at klikke på "Avanceret søgning" lige under førnævnte boks.',
	...
	'HELP_FAQ_USERSETTINGS_EMAIL_LOGIN_ANSWER'	=> 'Kun tilmeldte brugere kan sende e-mails via det indbyggede e-mailsystem, og kun hvis en administrator har slået denne funktion til. Dette er for at forhindre gæster i at misbruge e-mailsystemet.',
	'HELP_FAQ_USERSETTINGS_EMAIL_LOGIN_QUESTION'	=> 'Når jeg klikker på en brugers e-mail, bliver jeg bedt om at logge ind?',
