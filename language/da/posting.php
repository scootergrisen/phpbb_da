...
* @version $Id: posting.php 586 2017-07-23 12:23:55Z jan_skovsgaard $
*
...
$lang = array_merge($lang, array(
	...
	'ADD_ATTACHMENT_EXPLAIN'	=> 'Vælg den eller de filer du vil vedhæfte ved at klikke på Tilføj filer.',
	...
	'BBCODE_A_HELP'				=> 'Vis vedhæftet fil inline: [attachment=]filnavn.filtype[/attachment]',
	...
	'BBCODE_F_HELP'				=> 'Skriftstørrelse: [size=85]lille tekst[/size]',
	...
	'BBCODE_O_HELP'				=> 'Sorteret liste: For eksempel [list=1][*]Første punkt[/list] eller [list=a][*]Punkt a[/list]',
	'BBCODE_P_HELP'				=> 'Indsæt billede: [img]http://billed_url[/img]',
	'BBCODE_Q_HELP'				=> 'Citer tekst: [quote]tekst[/quote]',
	'BBCODE_S_HELP'				=> 'Skriftfarve: [color=red]tekst[/color] eller [color=#FF0000]tekst[/color]',
	...
	'DELETE_POST_PERMANENTLY_CONFIRM'	=> 'Er du sikker på, at du vil slette dette indlæg <strong>permanent</strong>?',
	'DELETE_POST_PERMANENTLY'	=> array(
		1	=> 'Når indlægget slettes permanent kan det ikke gendannes',
		2	=> 'Når %1$d indlæg slettes permanent kan de ikke gendannes',
	),
	'DELETE_POSTS_CONFIRM'		=> 'Er du sikker på, at du vil slette disse indlæg?',
	'DELETE_POSTS_PERMANENTLY_CONFIRM'	=> 'Er du sikker på, at du vil slette disse indlæg <strong>permanent</strong>?',
	...
	'DELETE_TOPIC_PERMANENTLY'	=> array(
		1	=> 'Når emnet slettes permanent kan det ikke gendannes',
		2	=> 'Når %1$d emner slettes permanent kan de ikke gendannes',
	),
	...
	'EMPTY_MESSAGE'				=> 'Du skal indtaste en besked for at skrive et indlæg.',
	...
	'NO_POLL_TITLE'				=> 'Du skal indtaste en afstemningstitel.',
	'NO_POST'					=> 'Det indtastede indlæg findes ikke.',
	'NO_POST_MODE'				=> 'Ingen indlægstilstand indtastet.',
	'NO_TEMP_DIR'				=> 'Midlertid mappe ikke fundet eller der kan ikke skrives til den.',

	'PARTIAL_UPLOAD'			=> 'Den uploadede fil blev kun delvist uploadet.',
	'PHP_UPLOAD_STOPPED'		=> 'En PHP-udvidelse afbrød upload af filen.',
	...
	'POLL_TITLE_COMP_TOO_LONG'	=> 'Den fortolkede afstemningstitel er for lang, overvej eventuelt at slette BBkoder eller smileys.',
	...
	'REMOTE_UPLOAD_TIMEOUT'		=> 'Den indtastede fil kunne ikke uploades fordi forespørgslen udløb.',
	'SAVE'						=> 'Gem',
	'SAVE_DATE'					=> 'Gemt',
	'SAVE_DRAFT'				=> 'Gem kladde',
	'SAVE_DRAFT_CONFIRM'		=> 'Bemærk venligst at gemte kladder kun inkluderer titlen og selve indholdet, alle andre elementer vil blive fjernet. Vil du gemme din kladde nu?',
	'SMILIES'					=> 'Smileys',
	'SMILIES_ARE_OFF'			=> 'Smileys er slået <em>FRA</em>',
	'SMILIES_ARE_ON'			=> 'Smileys er slået <em>TIL</em>',
	'STICKY_ANNOUNCE_TIME_LIMIT'=> 'Opslag/bekendtgørelse/global tidsbegrænsning',
	'STICK_TOPIC_FOR'			=> 'Opslå emne i',
	'STICK_TOPIC_FOR_EXPLAIN'	=> 'Indtastes 0, bevares indlægget som opslag/bekendtgørelse/global. Bemærk at antallet er relativt i forhold til datoen for indlæggets indsendelse.',
	...
	'TOO_MANY_USER_OPTIONS'		=> 'Du kan ikke indtaste flere muligheder pr. bruger end der findes afstemningsmuligheder.',
	...
	'URL_INVALID'				=> 'Den indtastede URL er ugyldig.',
	'URL_NOT_FOUND'				=> 'Den indtastede fil kunne ikke findes.',
	...
	'VIEW_MESSAGE'				=> '%sVis din indsendte besked%s',
