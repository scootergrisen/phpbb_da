...
* @version $Id: posting.php 585 2017-07-23 08:20:20Z jan_skovsgaard $
*
...
$lang = array_merge($lang, array(
	...
	'BBCODE_TAG'				=> 'Tag',
	'BBCODE_TAG_TOO_LONG'		=> 'Det valgte navn til tagget er for langt.',
	'BBCODE_TAG_DEF_TOO_LONG'	=> 'Den indtastede definition af tagget er for lang, afkort den venligst.',
	...
	'tokens'	=>	array(
		'TEXT'			=> 'Enhver tekst, inklusive ikke-engelske bogstaver (bl.a. æ, ø og å), tal osv… TEXT bør ikke anvendes som token i HTML-tags. Brug i stedet IDENTIFIER, INTTEXT eller SIMPLETEXT.',
...
$lang = array_merge($lang, array(
	...
	'ACP_SMILIES_EXPLAIN'	=> 'Smileys er typisk små, nogle gange animerede billeder der bruges til at give udtryk for en følelse eller mening. Fra denne side kan du tilføje, fjerne og rette de smileys som brugerne kan bruge i deres indlæg og private beskeder. Du kan også installere og oprette nye pakker med smileys.',
	'ADD_SMILIES'			=> 'Tilføj smileys',
	'ADD_SMILEY_CODE'		=> 'Tilføj yderligere smiley-kode',
	...
	'EXPORT_SMILIES'			=> 'Eksporter og download smileys.pak',
	'EXPORT_SMILIES_EXPLAIN'	=> '%sVed at klikke på dette link, vil konfigurationen for dine installerede smileys blive pakket i <samp>smileys.pak</samp> som, når den er downloadet, kan bruges til at lave en <samp>.zip</samp> eller en <samp>.tgz</samp> fil, som indeholder alle dine smileys, samt denne <samp>smileys.pak</samp> konfigurationsfil%s.',
	...
	'IMPORT_SMILIES'		=> 'Installer smileys-pakke',

	'KEEP_ALL'			=> 'Behold alle',

	'MASS_ADD_SMILIES'	=> 'Tilføj mange smileys',
	...
	'NO_SMILIES_ADD'	=> 'Ingen smileys tilgængelige for tilføjelse.',
	'NO_SMILIES_EDIT'	=> 'Ingen smileys tilgængelige for ændringer.',
	...
	'SMILIES_IMPORTED'			=> 'Smileys-pakken blev korrekt installeret.',
	'SMILIES_IMPORT_SUCCESS'	=> 'Smileys-pakken blev korrekt importeret.',
	'SMILIES_LOCATION'			=> 'Smileys placering',
	'SMILIES_NOT_DISPLAYED'		=> 'Følgende smileys vises ikke på siden hvor indlæg skrives',
	...
	'TOO_MANY_SMILIES'		=> array(
		...
		2	=> 'Grænsen på %d smileys er nået.',
	),
...
// Word censors
$lang = array_merge($lang, array(
	'ACP_WORDS_EXPLAIN'		=> 'Her kan du tilføje, rette og fjerne ord som automatisk skal censureres i dine fora. Brugere vil stadig kunne tilmelde sig med brugernavne indeholdende disse ord. (*) kan anvendes som ubekendt, for eksempel vil *bil* matche lastbildør, bil* ville matche bildør, *bil ville matche lastbil.',
...
$lang = array_merge($lang, array(
	...
	'DISALLOWED_ALREADY'		=> 'Det indtastede brugernavn er allerede afvist.',
	...
	'NO_USERNAME_SPECIFIED'		=> 'Brugernavn er enten ikke indtastet eller valgt.',
));

// Reasons
$lang = array_merge($lang, array(
	'ACP_REASONS_EXPLAIN'	=> 'Her administreres baggrunde for rapportering og afvisning af indlæg. Standardbeskeden (markeret med *) kan ikke slettes. Denne anvendes til at skrive egne begrundelser, når indlæggets karakter ikke kan beskrives med de prædefinerede.',
