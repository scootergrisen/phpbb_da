...
//	'ACC_USER_ADMIN'			=> 'User + Admin',
	'ALLOW_EMAIL_REUSE'			=> 'Tillad genbrug af email-adresse',
	'ALLOW_EMAIL_REUSE_EXPLAIN'	=> 'Forskellige brugere kan tilmelde sig med samme email-adresse.',
	'COPPA'						=> 'COPPA',
	'COPPA_FAX'					=> 'COPPA-telefaxnummer',
	'COPPA_MAIL'				=> 'COPPA-email-adresse',
	'COPPA_MAIL_EXPLAIN'		=> 'Indtast den email-adresse hvortil forældre eller værge kan sende COPPA-tilmeldingsformularerne.',
...
$lang = array_merge($lang, array(
	...
	'CONTACT_US_ENABLE_EXPLAIN'	=> 'Siden giver brugere mulighed for at sende emails til boardadministratorer. Bemærk venligst at boardets emailsystem også skal være aktiveret. Denne indstilling finder du under Generelt > Klientkonfiguration > Emails.',
...
$lang = array_merge($lang, array(
	...
	'LDAP_EMAIL_EXPLAIN'		=> 'Sæt denne til navnet på din brugertabels emailattribut (hvis en sådan findes) for automatisk at sætte email-adressen for nye brugere. Ved at lade dette felt være tomt vil brugere ved første login få tildelt en tom email-adresse.',
	'LDAP_INCORRECT_USER_PASSWORD'	=> 'Forbindelse til LDAP-server mislykkedes med anvendte brugernavn og adgangskode.',
	'LDAP_NO_EMAIL'				=> 'Den indtastede email-attribut findes ikke.',
...
// Email Settings
$lang = array_merge($lang, array(
	'ACP_EMAIL_SETTINGS_EXPLAIN'	=> 'Disse indstillinger anvendes af boardet ved forsendelse af emails til tilmeldte brugere. Bemærk venligst at denne email-adresse skal være gyldig, da enhver tilbagesendt eller vildfaren email sandsynligvis vil blive returneret til denne email-adresse. Hvis din vært ikke lader dig bruge den indbyggede (PHP-baserede) email-tjeneste, kan du i stedet sende emails direkte igennem SMTP. Dette kræver adressen på en passende server (spørg om nødvendigt din vært). Hvis serveren kræver godkendelse (og kun hvis den gør), indtastes det nødvendige brugernavn, adgangskode og godkendelsesmetoden.',

	'ADMIN_EMAIL'					=> 'Afsender email-adresse',
	'ADMIN_EMAIL_EXPLAIN'			=> 'Denne email-adresse bruges som afsenderadresse for alle emails, dvs. email-adressen for teknisk kontakt. Den bruges altid som <samp>Sender</samp> adressen i emails.',
	'BOARD_EMAIL_FORM'				=> 'Brugere sender emails via boardet',
	'BOARD_EMAIL_FORM_EXPLAIN'		=> 'Brugere kan tilsendes email via boardets emailsystem, selvom email-adresser er skjulte.',
	'BOARD_HIDE_EMAILS'				=> 'Skjul email-adresser',
	'BOARD_HIDE_EMAILS_EXPLAIN'		=> 'Denne funktion holder email-adresser fuldstændigt private.',
	'CONTACT_EMAIL'					=> 'Email-adresse for kontakt',
	'CONTACT_EMAIL_EXPLAIN'			=> 'Denne email-adresse bruges overalt, hvor der er specifikke kontaktpunkter, for eksempel spam, fejlmeddelelser, problemer med tilmelding osv. Den vil altid blive anvendt som <samp>From</samp> og <samp>Reply-To</samp>-adresserne i emails.',
	...
	'EMAIL_FORCE_SENDER'			=> 'Gennemtving afsender email-adresse',
	'EMAIL_FORCE_SENDER_EXPLAIN'	=> 'Indstiller <samp>Return-Path</samp> til afsender email-adressen i stedet for at anvende den lokale bruger og serverens hostnavn. Denne indstilling anvendes ikke når der bruges SMTP.<br><em><strong>Advarsel:</strong> Forudsætter at webserveren kører som tilføjet troværdig bruger til sendmail-konfigurationen.</em>',
	'EMAIL_PACKAGE_SIZE'			=> 'Pakkestørrelse for emails',
	'EMAIL_PACKAGE_SIZE_EXPLAIN'	=> 'Antallet af emails der afsendes i en pakke. Indstillingen tilføjes den interne kø. Sæt indstillingen til 0 hvis du oplever problemer med ikke leverede emails.',
	...
	'SEND_TEST_EMAIL_EXPLAIN'		=> 'Der afsendes en test-email til den mailadresse der er tilknyttet din konto.',
	...
	'TEST_EMAIL_SENT'				=> 'Der er netop afsendt en test-email.<br>Modtager du den ikke, bedes du kontrollere dine emailkonfigurationer.<br><br>Har du brug for assistance, kan du søge hjælp på <a href="https://www.phpbb.com/community/">phpBB support forums</a>.',
